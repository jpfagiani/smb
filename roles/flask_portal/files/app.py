    ...
    <form method="post" action="{{ url_for('restore_run') }}" onsubmit="return confirmRestore(this)">
      <div style="padding:1rem">
        ...
        <div style="display:flex;flex-direction:column;gap:.4rem;margin-top:.35rem">
          ...
          <label style="font-weight:400;font-size:.83rem"><input type="checkbox" name="rst_portal" value="1"> Portal (<code>/opt/cdpni-portal</code>) — o portal reinicia ao final</label>
...
def restore_run():
    ...
    if request.form.get('rst_portal'):  alvos.append(('Portal', ['opt/cdpni-portal']))
    ...
    snap_paths = [p for p in ('etc/samba', 'etc/passwd', 'etc/shadow', 'etc/group',
                              'var/lib/samba', 'opt/cdpni-portal')
                  if os.path.exists('/' + p)]
    ...
    if mexe_portal:
        ...
        linhas.append('echo "Reiniciando o portal..."; sleep 1; systemctl restart cdpni-portal')
